...
SalaryAnalysis['Python']

'Scala' in SalaryAnalysis

SalaryAnalysis.keys()
SalaryAnalysis.values()
SalaryAnalysis.items()

SalaryAnalysis.get('Python')

ExternalAnalysis = { 'Haskel': 5, 'Lisp': 10 }
SalaryAnalysis.update(ExternalAnalysis)

SalaryAnalysis.pop('Python')
